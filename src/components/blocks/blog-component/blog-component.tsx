    ...
    <section className='py-8 sm:py-16 lg:py-24' id='categories'>
      <div className='mx-auto max-w-7xl space-y-8 px-4 sm:px-6 lg:space-y-16 lg:px-8'>
        ...
        <div className='space-y-4'>
          {selectedTab === 'All' && <p className='text-sm'>Le Laboratoire</p>}
          {selectedTab !== 'All' && (
            <Breadcrumb>
              <BreadcrumbList>
                <BreadcrumbItem>
          ...
          <h2 className='text-2xl font-semibold md:text-3xl lg:text-4xl'>
            Forger des infrastructures résilientes et automatisées.
          </h2>

          <p className='text-muted-foreground text-lg md:text-xl'>
            Plonge dans mes séries dédiées aux outils d'Ingénieur DevOps. Maîtrise ses pilliers pour transformer ton infrastructure en code de haute précision, sans oublier mes Cheat Sheets pour tes défis quotidiens."
          </p>
        </div>

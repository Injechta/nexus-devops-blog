...
> « On dit que l'erreur est humaine, mais pour vraiment tout bousiller, il faut un ordinateur... et un `kubectl delete pod` lancé sur le mauvais namespace. Alors respire un grand coup, vérifie ton contexte, et rappelle-toi : **si ton cerveau affiche un** `404 Not Found` **devant ton terminal, c'est qu'il est temps d'aller chercher un café !** »
